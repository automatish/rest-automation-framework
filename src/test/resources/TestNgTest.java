...
public class TestNgTest {
	...
	public void init(ITestContext context)
	{
		...
		userDir=System.getProperty("user.dir")+"\\src\\test\\resources\\Output\\Report"+new SimpleDateFormat("yyyy-MM-dd-HH-mm-ss").format(new Date());
  ...
  public void textFile(Response response) throws IOException {
	  ...
	  File file=new File(System.getProperty("user.dir")+"\\src\\test\\resources\\Output\\Response_"+timeStamp+".txt");
	  file.createNewFile();
